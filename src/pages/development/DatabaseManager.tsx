...
const quickActions = [
  {
    ...
    href: '/development/database/tables',
    icon: Table2,
    color: 'bg-blue-500',
  },
  {
  ...
  },
  {
    ...
    href: '/development/database/import',
    icon: Upload,
    color: 'bg-green-500',
  },
  {
    ...
    href: '/development/database/export',
    icon: Download,
    color: 'bg-orange-500',
  },
]
        ...
        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <Link
                to="/development/database/sql?tab=slow-queries"
